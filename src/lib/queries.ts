...
export const createTeamUser = async (agencyId: string, user: User) => {
  ...
  // Check if a user with the same primary key already exists
...
export const saveActivityLogsNotification = async ({
  ...
  if (!foundAgencyId) {
    if (!subaccountId) {
      throw new Error(
        "You need to provide to provide an agency id or a subaccount id"
      );
    }
  }
...
export const sendInvitation = async (
  ...
  // Check if an invitation with the given email already exists
